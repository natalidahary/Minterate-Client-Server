...
import com.example.myapplication.databinding.ActivityAboutMenuBinding
...
class AboutMenuActivity:  AppCompatActivity() {
    ...
    private lateinit var binding: ActivityAboutMenuBinding
    ...
    private lateinit var aboutUsHeader: AppCompatTextView
    private lateinit var welcomeHeader: AppCompatTextView
    private lateinit var welcomeContent: AppCompatTextView
    private lateinit var ourVisionHeader: AppCompatTextView
    private lateinit var ourContent: AppCompatTextView
    private lateinit var keyFeaturesHeader: AppCompatTextView
    private lateinit var keyFeaturesContent: AppCompatTextView
    private lateinit var securityAndInnovationHeader: AppCompatTextView
    private lateinit var securityAndInnovationContent: AppCompatTextView
    private lateinit var ourPromiseHeader: AppCompatTextView
    private lateinit var ourPromiseContent: AppCompatTextView
    private lateinit var joinusContent: AppCompatTextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAboutMenuBinding.inflate(layoutInflater)
        ...
        binding.aboutBTNExitButton.setOnClickListener {
    ...
    private fun findViews() {
        exitButton = findViewById(R.id.about_BTN_exitButton)
        aboutUsHeader = findViewById(R.id.aboutUsHeader)
        welcomeHeader = findViewById(R.id.welcomeHeader)
        welcomeContent = findViewById(R.id.welcomeContent)
        ourVisionHeader = findViewById(R.id.ourVisionHeader)
        ourContent = findViewById(R.id.ourContent)
        keyFeaturesHeader = findViewById(R.id.keyFeaturesHeader)
        keyFeaturesContent = findViewById(R.id.keyFeaturesContent)
        securityAndInnovationHeader = findViewById(R.id.securityAndInnovationHeader)
        securityAndInnovationContent = findViewById(R.id.securityAndInnovationContent)
        ourPromiseHeader = findViewById(R.id.ourPromiseHeader)
        ourPromiseContent = findViewById(R.id.ourPromiseContent)
        joinusContent = findViewById(R.id.joinusContent)
    ...
    private fun applyTextScalar() {
        val textElements = listOf(
            aboutUsHeader, welcomeHeader, welcomeContent, ourVisionHeader, ourContent, keyFeaturesHeader,
            keyFeaturesContent, securityAndInnovationHeader, securityAndInnovationContent, ourPromiseHeader,
            ourPromiseContent, joinusContent
